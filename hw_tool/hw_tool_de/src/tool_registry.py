...
TOOL_SPECS = (
    ...
    ToolSpec(
        ...
        usage="hw_tool de rtl_inst <rtl_path> [-o inst.sv|--stdout]",
    ...
    ToolSpec(
        ...
        repository_name="py_tools_for_hw",
        example="py_rtl_sim/gen_tb_demo/README.md",
    ...
    ToolSpec(
        name="md2html",
        script="py_md2html/src/py_md2html.py",
        description="Convert Markdown documents to standalone HTML pages.",
        usage="hw_tool de md2html <input.md> [-o output.html] [--toc]",
        doc_url="https://github.com/damagebro/py_tools_for_hw/blob/main/py_md2html/README.md",
        readme="py_md2html/README.md",
        repository_name="py_tools_for_hw",
        doctor_packages=("markdown",),
        example="py_md2html/README.md",
        smoke_args=("{example}", "-o", "{output}/README.html"),
        smoke_outputs=("README.html",),
        unit_tests=("py_md2html/test/test_py_md2html.py",),
        unit_cwd="py_md2html",
    ),
    ToolSpec(
        name="git_repo_mgr",
    ...
    ToolSpec(
        ...
        usage="hw_tool de rtl_flist_mgr --core <core_id/name> -o <output.f> [-m sim|synth|lint|emu|fpga] [options]",
